package com.github.teamasia.heartrider.ui;
...
public class SensorGraphView extends View {
    ...
    private static final int CIRCLE_SIZE_ACCURACY_MEDIUM = 4;
    private static final int CIRCLE_SIZE_ACCURACY_LOW = 4;
    private static final int CIRCLE_SIZE_DEFAULT = 4;

    private static final int MAX_DATA_SIZE = 70;
