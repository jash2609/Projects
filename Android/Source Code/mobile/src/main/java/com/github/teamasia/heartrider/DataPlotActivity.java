...
import com.github.teamasia.heartrider.events.BusProvider;
import com.github.teamasia.heartrider.events.NewSensorEvent;
import com.github.teamasia.heartrider.jash.RatingActivity;
import com.github.teamasia.heartrider.jash.TwitterLoginActivity;
import com.github.teamasia.heartrider.ui.ExportActivity;
...
public class DataPlotActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tweet_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent activityIntent = new Intent(DataPlotActivity.this, TwitterLoginActivity.class);
        ...
        findViewById(R.id.rate_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent activityIntent = new Intent(DataPlotActivity.this, RatingActivity.class);
                activityIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(activityIntent);
            }
        });
        ...
        findViewById(R.id.tag_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RemoteSensorManager.getInstance(DataPlotActivity.this).addTag(tagnameText);
            }
        });
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    switch (item.getItemId()) {
                        /*case R.id.action_about:
                            startActivity(new Intent(DataPlotActivity.this, AboutActivity.class));
                            return true;*/
                        case R.id.action_export:
                            startActivity(new Intent(DataPlotActivity.this, ExportActivity.class));
                            return true;
                    }
